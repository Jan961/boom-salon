"""
Django settings for boom_saloon project.
...
SECRET_KEY = 'django-insecure-cfs9z62t$-%vd2*x__#uud!1*(u@=$x!6=3j4+)hx%0k^drq1-'
...
WSGI_APPLICATION = 'boom_saloon.wsgi.application'
